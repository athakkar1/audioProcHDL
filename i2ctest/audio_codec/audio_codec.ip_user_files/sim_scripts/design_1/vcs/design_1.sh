...
#
# Script generated by Vivado on Sat Oct 05 17:13:08 EDT 2024
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/somalianpirate/Documents/projects/audio_codec/audio_codec.cache/compile_simlib/vcs"
  fi
