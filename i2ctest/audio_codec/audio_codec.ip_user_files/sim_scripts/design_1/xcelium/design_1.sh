...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../audio_codec.gen/sources_1/bd/design_1/ipshared/6b2b/hdl" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/somalianpirate/Documents/projects/audio_codec/audio_codec.cache/compile_simlib/xcelium"
  fi
